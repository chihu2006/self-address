...
def main():
    ...
    # Merge all entries for testing
    all_entries = filtered_entries + ctv_entries
    ...
    for idx, (extinf, url) in enumerate(all_entries, start=START_INDEX):
